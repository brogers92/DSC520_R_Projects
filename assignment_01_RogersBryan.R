...
num_days_over_8 <- sum(week1_sleep > 8)
num_days_over_8
...
rownames(matrix) <- students
colnames(matrix) <- assignments
...
sorted_characters_df <- characters_df[order(character_df$age),]
